<footer class="bg-brand-blue-dk text-white/80">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <!-- About -->
            <div>
                <h4 class="font-display text-lg text-white font-semibold mb-4">Mouvement des Femmes de Foi</h4>
                <p class="text-sm leading-relaxed text-white/60">Association humanitaire &agrave; but non lucratif (loi 1901). Apporter soutien, espoir et assistance aux personnes les plus vuln&eacute;rables.</p>
                <p class="text-brand-gold italic text-sm mt-3 font-display">&laquo; Avec la foi, tout est possible &raquo;</p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ route('donate') }}" class="hover:text-brand-gold-lt transition">Faire un don</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li>{{ setting('email', 'contact@amfdf.org') }}</li>
                    <li>{{ setting('phone', '') }}</li>
                    <li>{{ setting('address', 'France / International') }}</li>
                </ul>
                <div class="flex gap-4 mt-4">
                    @if(setting('facebook_url'))
                    <a href="{{ setting('facebook_url') }}" target="_blank" class="hover:text-brand-gold-lt transition" aria-label="Facebook">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
                    </a>
                    @endif
                    @if(setting('instagram_url'))
                    <a href="{{ setting('instagram_url') }}" target="_blank" class="hover:text-brand-gold-lt transition" aria-label="Instagram">
                    ...
                    <a href="https://wa.me/{{ setting('whatsapp_number') }}" target="_blank" class="hover:text-brand-gold-lt transition" aria-label="WhatsApp">
            ...
            <div>
                ...
                <blockquote class="text-sm italic text-white/60 border-l-2 border-brand-gold pl-4">
                    &laquo; J&eacute;sus est le chemin, la v&eacute;rit&eacute; et la vie &raquo;<br>
    ...
    <div class="border-t border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-white/40">
            <p>&copy; {{ date('Y') }} Mouvement des Femmes de Foi. Tous droits r&eacute;serv&eacute;s.</p>
